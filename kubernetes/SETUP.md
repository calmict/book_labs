...
Tear down when done: \`kind delete cluster --name book-labs\`.
...
Tear down: \`k3d cluster delete book-labs\`.
...
If \`kubectl get nodes\` shows a \`Ready\` node, you can start any exercise.
