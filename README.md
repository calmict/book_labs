...
human-readable briefs are bilingual, via the README.it.md / README.en.md suffix.

**Editions.** Everything cited by the 1st edition of a manual lives under an
ed1/ folder and is frozen once that edition is published. A later edition is
added as a new edN/ folder, leaving the previous one untouched, so every link
in an already-published book keeps working forever.
...
and step-by-step instructions. Open the start/ folder, do the work, and
compare with solution/ when you are done.
